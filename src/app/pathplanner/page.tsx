...
export default function PathPlanner() {
  return (
    ...
    >
      ...
      <Box variant="alert-info" title="PathPlanner Integration">
        <p className="mb-2">
      ...
      <section className="flex flex-col gap-8">
        ...
        <Box
          variant="alert-info"
          title="🔍 Exploring the Swerve Implementation"
        >
          <p className="mb-3">
  ...
  try {
    ...
    private void configureNamedCommands() {
      ...
      <section className="flex flex-col gap-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Box variant="alert-tip" title="Path Creation">
          ...
          <Box variant="alert-warning" title="Common Pitfalls">
            <ul className="list-disc list-inside space-y-2 text-sm text-slate-600 dark:text-slate-300">
              <li>
