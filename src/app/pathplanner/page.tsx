...
export default function PathPlanner() {
  return (
    ...
    >
      ...
      <AlertBox variant="info" title="PathPlanner Already Integrated">
        <p className="mb-2">
          ...
          demonstrates this integration across several pull requests:
        </p>
        <ul className="list-disc list-inside space-y-1 text-sm text-slate-600 dark:text-slate-300">
          <li>
            <strong>PR #7:</strong> Initial swerve drivetrain with PathPlanner
            configuration
          </li>
          <li>
            <strong>PR #8:</strong> PathPlanner autonomous paths and named
            commands
          </li>
          <li>
            <strong>PR #9:</strong> Advanced path following with event markers
          </li>
        </ul>
      </AlertBox>
    ...
    // PathPlanner library
    implementation 'com.pathplanner.lib:PathplannerLib:2025.0.0-beta-1'
}`}
            />
          </div>
...
public CommandSwerveDrivetrain(
    ...
    AutoBuilder.configureHolonomic(
      ...
      <section className="flex flex-col gap-8">
        ...
        <p className="text-slate-600 dark:text-slate-300">
          The Workshop-Code repository demonstrates PathPlanner integration
          through a series of pull requests. Each PR builds on the previous one,
          showing the progressive development workflow.
        </p>

        <GitHubPR
          repository="Hemlock5712/Workshop-Code"
          pullRequestNumber={7}
          title="PR #7: Initial Swerve with PathPlanner Setup"
          description="This PR shows the initial swerve drivetrain setup with PathPlanner AutoBuilder configuration. The CommandSwerveDrivetrain includes all necessary methods for path following."
        />

        <GitHubPR
          repository="Hemlock5712/Workshop-Code"
          pullRequestNumber={8}
          title="PR #8: PathPlanner Paths and Named Commands"
          description="This PR adds actual PathPlanner path files and demonstrates how to create autonomous routines using paths and named commands."
        />

        <GitHubPR
          repository="Hemlock5712/Workshop-Code"
          pullRequestNumber={9}
          title="PR #9: Advanced PathPlanner Features"
          description="This PR showcases advanced PathPlanner features including event markers, path groups, and complex autonomous sequences."
        />
      </section>
